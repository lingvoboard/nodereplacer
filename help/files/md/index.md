...
При сравнении двух символов положение которых относительно друг друга не задано в **sortRules.txt_** сортировка производится по кодовым точкам (unicode code point)     
...
Пример содержания **sortRules.txt** если нужна, к примеру, обратная сортировка:</br>
