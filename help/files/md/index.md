...
pig
        свинья 1
```
-**bi** - _сортировать статьи по заголовкам с учетом содержимого тела карточки_.

_И при сортировке игнорировать в заголовках:_
...
pig
        свинья 2
```
-**bie** - _это расширенный вариант -**bi**_.

_При сортировке игнорируются также_:

а) _символы: «»"„“”‘’…_

б) _многоточие из обычных точек (это помимо Horizontal ellipsis (U+2026))_

в) _диакритические знаки в символах_ ё _и_ Ё.

г) _круглые скобки и все, что находится между ними_

-**oi** - _сортировать статьи по заголовкам, но с сохранением оригинального порядка в блоке статей имеющих одинаковый заголовок_.

_И при сортировке игнорировать в заголовках_:
...
pig
        свинья 1
```
-**oie** - _это расширенный вариант -**oi**_.
