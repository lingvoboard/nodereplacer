...
o.Messages["1"] = ["Предупреждение", 'В заголовке присутствуют символы, не поддерживаемые в данном языке.', 0];
o.Messages["2"] = ["Предупреждение", 'Изображение для значка словаря имеет неправильные размеры.', 0];
o.Messages["3"] = ["Предупреждение", 'Правильные размеры изображения: 14 х 21 пикселов.', 0];
o.Messages["4"] = ["Предупреждение", 'Подвешенная ссылка "%s".', 0, 'Подвешенных ссылок'];
o.Messages["5"] = ["Предупреждение", 'Символ "\" в конце строки не имеет силы и игнорируется.', 0];

o.Messages["6"] = ["Ошибка", 'Повторный открывающий тег.', 0];
o.Messages["7"] = ["Ошибка", 'Отсутствует закрывающий тег.', 0];
o.Messages["8"] = ["Ошибка", 'Закрывающий тег при отсутствии открывающего.', 0];
o.Messages["9"] = ["Ошибка", 'Использование тегов внутри ссылки на карточку запрещено.', 0, 'Использование тегов внутри ссылки на карточку'];
o.Messages["10"] = ["Ошибка", 'Использование тегов внутри зоны мультимедиа запрещено.', 0, 'Использование тегов внутри зоны мультимедиа'];
o.Messages["11"] = ["Ошибка", 'Использование тегов внутри URL запрещено.', 0, 'Использование тегов внутри URL'];
...
o.Messages["15"] = ["Ошибка", 'Отсутствуют открывающие комментарий скобки.', 0];
o.Messages["16"] = ["Ошибка", 'Отсутствуют закрывающие комментарий скобки.', 0];
o.Messages["17"] = ["Ошибка", 'Тег "[!trs]" может находиться только внутри одной из зон индексации.', 0];
o.Messages["18"] = ["Ошибка", 'Язык "%s" не поддерживается.', 0, 'Неподдерживаемый язык'];
o.Messages["19"] = ["Ошибка", 'Идентификатор языка "%s" не поддерживается.', 0, 'Неподдерживаемый идентификатор языка'];
o.Messages["20"] = ["Ошибка", 'Неизвестное имя цвета: "%s".', 0, 'Неизвестное имя цвета'];
o.Messages["21"] = ["Ошибка", 'Отсутствуют параметры тега: "[lang]".', 0];
o.Messages["22"] = ["Ошибка", 'Имя языка без кавычек.', 0];
o.Messages["23"] = ["Ошибка", 'Отсутствует символ закрытия альтернативной части заголовка ")".', 0];
o.Messages["24"] = ["Ошибка", 'Отсутствует символ открытия альтернативной части заголовка "(".', 0];
o.Messages["25"] = ["Ошибка", 'Отсутствует символ закрытия несортируемой части заголовка "}".', 0];
o.Messages["26"] = ["Ошибка", 'Отсутствует символ открытия несортируемой части заголовка "{".', 0];
o.Messages["27"] = ["Ошибка", 'В заголовке слишком много альтернативных частей, максимально - 6.', 0];
o.Messages["28"] = ["Ошибка", 'Заголовок "%s" уже обработан.', 0, 'Заголовок уже обработан'];
...
o.Messages["33"] = ["Ошибка", 'Неизвестная директива препроцессора: "%s".', 0, 'Неизвестная директива препроцессора'];
o.Messages["34"] = ["Ошибка", 'Параметр для директивы препроцессора "%s" должен быть заключен в кавычки.', 0, 'Параметр для директивы препроцессора без кавычек'];
o.Messages["35"] = ["Ошибка", 'Пустая статья.', 0];
o.Messages["36"] = ["Ошибка", 'Пустой заголовок карточки.', 0];
o.Messages["37"] = ["Ошибка", 'Повторное использование директивы %s.', 0, 'Повторное использование директивы'];
o.Messages["38"] = ["Ошибка", 'Неэкранированный символ # в начале строки за пределами блока директив.', 0];
o.Messages["39"] = ["Ошибка", 'Имя словаря "%s" содержит символы, не входящие в набор ASCII.', 0, 'Имя словаря содержит символы, не входящие в набор ASCII'];
o.Messages["40"] = ["Ошибка", 'Значение параметра dict должно быть заключено в кавычки.', 0];
o.Messages["41"] = ["Ошибка", 'Значение параметра dict содержит недопустимый символ.', 0];
o.Messages["42"] = ["Ошибка", 'Не задано значение параметра тега.', 0];
o.Messages["43"] = ["Ошибка", 'Директива препроцессора должна начинаться с новой строки.', 0];
o.Messages["44"] = ["Ошибка", 'Неправильное использование символа начала подкарточки "@".', 0];
o.Messages["45"] = ["Ошибка", 'Подкарточка не окончена.', 0];
o.Messages["46"] = ["Ошибка", 'Использование тегов внутри зоны транскрипции запрещено.', 0];
o.Messages["47"] = ["Ошибка", 'Пустая подкарточка.', 0];
o.Messages["48"] = ["Ошибка", 'Пустой подзаголовок.', 0];
o.Messages["49"] = ["Ошибка", 'Использование подкарточки внутри ссылки на карточку запрещено.', 0, 'Использование тегов внутри ссылки на карточку'];
o.Messages["50"] = ["Ошибка", 'Использование подкарточки внутри зоны мультимедиа запрещено.', 0, 'Использование тегов внутри зоны мультимедиа'];
o.Messages["51"] = ["Ошибка", 'Использование подкарточки внутри URL запрещено.', 0, 'Использование тегов внутри URL'];
o.Messages["52"] = ["Ошибка", 'Использование подкарточки внутри зоны транскрипции запрещено.', 0];
o.Messages["53"] = ["Ошибка", 'Слишком длинное слово.', 0];
o.Messages["54"] = ["Ошибка", 'Слишком длинный заголовок.', 0];
o.Messages["55"] = ["Ошибка", 'Тег "[sup]" не может находиться внутри зоны действия тега "[sub]".', 0];
o.Messages["56"] = ["Ошибка", 'Тег "[sub]" не может находиться внутри зоны действия тега "[sup]".', 0];
o.Messages["57"] = ["Ошибка", 'Заголовок целиком состоит из альтернативной части.', 0];
o.Messages["58"] = ["Ошибка", 'Использование символа начала имени тега "[" недопустимо внутри ссылки.', 0];
o.Messages["59"] = ["Ошибка", 'Отсутствует тег открытия ссылки "<<".', 0];
o.Messages["60"] = ["Предупреждение", 'В заголовке присутствуют символы, не поддерживаемые в данном языке.', 0];
...
o.CommentMap.count = 0;
	...
	else if ((process.argv.length === 6) && (process.argv[3] === '-t') && (o.utils.fileExists(process.argv[4])))
	{
	...
	else if ((process.argv.length === 6) && (process.argv[3] === '-c') && (o.utils.fileExists(process.argv[4])))
	{
	...
	else if ((process.argv.length === 6) && (/^-[tc]{2}$/.test(process.argv[3])) && (o.utils.fileExists(process.argv[4])))
	{
...
function updateProgressBar()
{
	...
	process.stdout.write(`${ '█'.repeat(barsNumber) }${ ' '.repeat(padsNumber) } ${readPercent}%`);
}
...
let TSRefUrl = undefined;

let InsideIndexZone = [];

let InsideSubSupZone = undefined;
...
function CheckDslArtBody(body0, art_num)
{
	...
	if (err !== undefined)
	{
		...
		let line = err[1];
 		...
 		if (err[2] === undefined)
 		{
 			body0[line] += '{{=' + o.Messages[errcode][0] + ': ' + o.Messages[errcode][1]  +  '}}'; 
 		}
 		else
 		{
 			body0[line] += err[2]; 
...
let re = /[^]*?(\S{256,})/y;
	...
	while (m = re.exec(s))
	{
		...
		if (w.length > 255)
		{
			s = s.substr(0, re.lastIndex) + '{{=' + o.Messages[53][0] + ': ' + o.Messages[53][1]  +  '}}' + s.substr(re.lastIndex);
			o.Messages[53][2]++;
			break;
		}
	...
	TSRefUrl = undefined;
		...
		if (tags[name][0].length > 0)
		{
			...
			else
			{
				...
				if ((tag === '>>') && (tags[name][0][tags[name][0].length - 1][2] !== '<<'))
				{
					Article[k][2].push([59, tag]);
				}
				else if ((tag === '[/ref]') && (tags[name][0][tags[name][0].length - 1][2] === '<<'))
				{
					Article[k][2].push([58, tag]);
				}
				else if ((name === 'ref') && (k > 1) && (Article[k-1][0] === 0) && (Article[k-2][0] === 1) && ((Article[k-2][1] === '[ref]')||(Article[k-2][1] === '<<')) && (Article[k-1][1].trim().length > 0))
				{
					let lnk = o.utils.remove_comments(Article[k-1][1]).replace(/[\t ]{2,}/g, " ").trim();
...
while (m = re.exec(s))
{
	...
	if (((m[2].length % 2) === 1) && (m[3] !== '}}'))
	{
		...
		if (txt !== '')
		{
			...
			if ((Article[pos-1]) && (Article[pos-1][0] === 0) && (Article[pos-1][2].length === 0))
			{
				Article[pos-1][1] += txt;
			}
			else
...
for (let k of keys)
{
	...
	s += el[1];
		...
		for (let e of el[2])
		{
			s += "{{=" + o.Messages[e[0]][0] + ": " + o.Messages[e[0]][1].replace(/%s/, e[1]) + "}}";
			o.Messages[e[0]][2]++;
		}
...
function ProcessDSLArticle(art0, art1, art_num)
{
	...
	if (info[3] === 0)
	{
		...
		if (info[0] === 0)
		{
			...
			art0[0] =  '{{=' + o.Messages[36][0] + ': ' + o.Messages[36][1] +   "}}\n" + art0[0];
			o.Messages[36][2]++;
		...
		for (let i = 0; i < art1.length; i++)
		{
			...
			if (/^[^\t\x20].*$/.test(art1[i]))
			{
				...
				if (/^@/.test(art1[i]))
				{
					...
					hw0[i] = hw0[i] + '{{=' + o.Messages[44][0] + ': ' + o.Messages[44][1] +   '}}';
					o.Messages[44][2]++;
				...
				else
				{
					...
					if (h.length > 246)
					{
						...
						hw0[i] = hw0[i] + '{{=' + o.Messages[54][0] + ': ' + o.Messages[54][1] +   '}}';
						o.Messages[54][2]++;
					...
					else if (tagchkres[0])
					{
						...
						hw0[i] = hw0[i] + '{{=' + o.Messages[tagchkres[1]][0] + ': ' + o.Messages[tagchkres[1]][1] +   '}}';
					...
					else
					{
						...
						if (!hs[1][8])
						{
							...
							for (let v of hs[0])
							{
								...
								if (h === '')
								{
									err.push('{{=' + o.Messages[57][0] + ': ' + o.Messages[57][1].replace(/%s/, h)  +   '}}');
									o.Messages[57][2]++;
								...
								else
								{
									...
									{
										err.push('{{=' + o.Messages[28][0] + ': ' + o.Messages[28][1].replace(/%s/, h)  +   '}}');
										o.Messages[28][2]++;
									}
									...
									if ((o.isLatin) && (!/^[\u0000-\u007F\u0080-\u00FF\u0100-\u017F\u0180-\u024F]+$/u.test(h)))
									{
										err.push('{{=' + o.Messages[60][0] + ': ' + o.Messages[60][1]  +   '}}');
										o.Messages[60][2]++;
									}
									else if ((o.isRussian) && (o.cyr) && (!/^[а-яёα-ωίϊΐόάέύϋΰήώ\u0020-\u0040\u005B-\u0060\u007B-\u007E\u00A2-\u00BE\u00D7\u00F7]+$/iu.test(h)))
									{
						...
						else
						{
							...
							if (hs[1][0] === 1)
							{
								err.push('{{=' + o.Messages[23][0] + ': ' + o.Messages[23][1]  +   '}}');
								o.Messages[23][2]++;
							}
					
							if (hs[1][1] === 1)
							{
								err.push('{{=' + o.Messages[24][0] + ': ' + o.Messages[24][1]  +   '}}');
								o.Messages[24][2]++;
							}
								
							if (hs[1][2] === 1)
							{
								err.push('{{=' + o.Messages[25][0] + ': ' + o.Messages[25][1]  +   '}}');
								o.Messages[25][2]++;
							}
				
							if (hs[1][3] === 1)
							{
								err.push('{{=' + o.Messages[26][0] + ': ' + o.Messages[26][1]  +   '}}');
								o.Messages[26][2]++;
							}
				
							if (hs[1][4] === 1)
							{
								err.push('{{=' + o.Messages[27][0] + ': ' + o.Messages[27][1]  +   '}}');
								o.Messages[27][2]++;
							}						
	
							if (hs[1][5] === 1)
							{
								err.push('{{=' + o.Messages[44][0] + ': ' + o.Messages[44][1]  +   '}}');
								o.Messages[44][2]++;
							}						
	
							if (hs[1][6] === 1)
							{
								err.push('{{=' + o.Messages[43][0] + ': ' + o.Messages[43][1]  +   '}}');
								o.Messages[43][2]++;
							}						

							if (hs[1][7] === 1)
							{
								err.push('{{=' + o.Messages[57][0] + ': ' + o.Messages[57][1]  +   '}}');
								o.Messages[57][2]++;
							}						
	...
	if (openComment[0])
	{
		...
		if (openComment[1][0] === lineCount)
		{
			if (o.CommentMap[lineCount] !== undefined)
			{
				...
				openComment = [true, o.CommentMap[lineCount][1], openComment[2] += "\n" + line];
				line = undefined;
...
while (lines.length)
{
	...
	if ((/^#/.test(s[1])) && (flag === 0))
	{
		...
		if (m = /^#(NAME|INDEX_LANGUAGE|CONTENTS_LANGUAGE|ICON_FILE|INCLUDE|SOURCE_CODE_PAGE)[ \t]+([^\s])(.*)([^\s])$/.exec(s[1]))
		{
			...
			if (m[2] !== '"' && m[4] !== '"')
			{
				...
				o.Messages[34][2]++;
				fs.writeSync(output, `{{=${o.Messages[34][0]}: ${msg}}}\n`, null, encoding);
			}
			else if (DirBlock[m[1]] !== undefined)
			{
				let msg = o.Messages[37][1].replace(/%s/, m[1]);
				o.Messages[37][2]++;
				fs.writeSync(output, `{{=${o.Messages[37][0]}: ${msg}}}\n`, null, encoding);
			}
			else if ((m[1] === 'INDEX_LANGUAGE'||m[1] === 'CONTENTS_LANGUAGE') && (o.Languages[m[3]] === undefined))
			{
				let msg = o.Messages[18][1].replace(/%s/, m[3]);
				o.Messages[18][2]++;
				fs.writeSync(output, `{{=${o.Messages[18][0]}: ${msg}}}\n`, null, encoding);	
			}
			else if ((m[1] === 'INDEX_LANGUAGE'||m[1] === 'CONTENTS_LANGUAGE') && (o.Languages[m[3]] !== undefined))
			{
				DirBlock[m[1]] = m[3];
		...
		else if (/^#\s*$/.test(s[1]))
		{
			...
			fs.writeSync(output, `{{=${o.Messages[32][0]}: ${o.Messages[32][1]}}}\n`, null, encoding);	
			o.Messages[32][2]++;
			
		}
		else if (m = /^#((?!NAME|INDEX_LANGUAGE|CONTENTS_LANGUAGE|ICON_FILE|INCLUDE|SOURCE_CODE_PAGE).*)$/.exec(s[1]))
		{

			let dir = m[1].replace(/^([^\s]+)\s.*$/, "$1");
			let msg = o.Messages[33][1].replace(/%s/, dir);
			o.Messages[33][2]++;
			fs.writeSync(output, `{{=${o.Messages[33][0]}: ${msg}}}\n`, null, encoding);	
	...
	else if (((/^[^\t ].*$/.test(s[1])) && (flag !== 1))||((/^[\t ].*[^\t ].*$/.test(s[1]))&&((art1.length === 0)||(flag === 3))))
	{
			...
			if (art0.length > 0)
			{
				...
				if (articleCount === 0)
				{
					...
					{
						fs.writeSync(output, `{{=${o.Messages[31][0]}: ${o.Messages[31][1]}}}\n`, null, encoding);
						o.Messages[31][2]++;
					}

					if (DirBlock['INDEX_LANGUAGE'] === undefined)
					{
						fs.writeSync(output, `{{=${o.Messages[30][0]}: ${o.Messages[30][1]}}}\n`, null, encoding);
						o.Messages[30][2]++;
					}

					if (DirBlock['CONTENTS_LANGUAGE'] === undefined)
					{
						fs.writeSync(output, `{{=${o.Messages[29][0]}: ${o.Messages[29][1]}}}\n`, null, encoding);
						o.Messages[29][2]++;
					}
	...
	if (errors > 0)
	{
		...
		fs.writeFileSync(o.error_log_path, "\n" + ' {{Ошибки: ' + errors + '}}' + "\n\n", {encoding: 'utf8', flag: "a"});
		...
		for (let k in o.Messages)
		{
			if (o.Messages[k][2] > 0)
			{
				...
				if (o.Messages[k][0] === 'Ошибка')
				{
					...
					fs.writeFileSync(o.error_log_path, " " + o.Messages[k][ind].replace(/\.$/, "").replace(/%s/, "x") + ": " + o.Messages[k][2] + "\n", {encoding: 'utf8', flag: "a"});
				}
			}
	...
	if (errors === 0)
	fs.writeFileSync(o.error_log_path, "\n {{Number of headwords: " + Object.keys(o.HeadWords1).length + ". Number of entries: " + o.ArticleCountGlobal + ".}}\n", {encoding: 'utf8', flag: "a"});	
				...
				if (!/^@/.test(hw[i]))
				{
					...
					if (!hs[1][8])
					{
						...
						for (let v of hs[0])
						{
							...
							v = o.utils.remove_scb(v).replace(/[\t ]{2,}/g, " ").trim();
		...
		if (info[4] > 0)
		{
			...
			for (let i = 0; i < body.length; i++)
			{
				...
				if (dogs[0] === 1)
				{
					...
					if (o.utils.remove_comments(body[i].substr(dogs[1])).trim() === '')
					{
						...
						if ((subs.length > 0) && (subs[subs.length -1][0]) && (subs[subs.length -1][3] === 0) && (subs[subs.length -1][2] === 0))
						{
						...
						else if ((subs.length > 0) && (subs[subs.length -1][0]) && (subs[subs.length -1][3] === 0) && (subs[subs.length -1][2] > 0))
						{
						...
						else if ((subs.length === 0)||((subs.length > 0) && (!subs[subs.length -1][0])))
						{
					...
					else
					{
						...
						else
						{
							...
							else
							{
								...
								if ((subs.length > 0) && (subs[subs.length - 1][0]) && (subs[subs.length - 1][1].length > 0) && (subs[subs.length - 1][2] === 0) && (subs[subs.length - 1][3] === 0))
								{
								...
								else
								{
									...
									if ((subs.length > 0) && (subs[subs.length - 1][0]) && (subs[subs.length - 1][3] === 0))
										subs[subs.length - 1][3] = 1;
				...
				else if (dogs[0] === 0)
				{
					...
					if ((subs.length > 0) && (subs[subs.length -1][0]) && (subs[subs.length -1][3] === 0) && (body[i].trim().length > 0))
					{
			...
			for (let v of hw3)
			{
				...
				if (v[0].length > 0)
				{
					...
					{
						return [true, 28, v[1], '{{=Ошибка: Заголовок "' + b.trim() + '" уже обработан.}}'];
					}
...
while (lines.length)
{
	...
	else if (((/^[^\t ].*$/.test(s)) && (flag !== 1))||((/^[\t ].*[^\t ].*$/.test(s))&&((art.length === 0)||(flag === 3))))
	{
