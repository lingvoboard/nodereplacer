// thanks to https://github.com/btford/eshighlight

var esprima = require('esprima')

var notControlFlow = ['var', 'let', 'const', 'function']
...
module.exports = function highlight (src) {
  ...
  tokens = ast.tokens.concat(
    ast.comments.map(function (comment) {
  ...
  tokens.forEach(function (token) {
    ...
    if (range && range.substr(-7) === '.params') {
